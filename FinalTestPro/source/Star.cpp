...
void Star::init()
{
	...
	filemgr->loadObj(this, "sphere.obj", "star.bmp", "20161651_vs.shader", "20161651_fs.shader");
...
void Star::setRotation(float speed, float x, float y, float z)
{
	rotateSpeed = speed;
...
void Star::setCameraPos(float x, float y, float z)
{
	cameraPos = glm::vec3(-x, -y, -z);
}

void Star::AddChild(Composite* addObj)
{
